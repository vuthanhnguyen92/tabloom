...
Before shipping this shared-organizer release, apply the entire migration chain in order, including `202609100005_workspace_link_move.sql`, `202609100006_workspace_sync_restore.sql`, `202609100007_workspace_restore_recovery.sql`, `202609100008_workspace_trash_identity_history.sql`, and `202609100009_workspace_collection_move_sync.sql`. They provide structural link movement, explicit restore synchronization, retry/outcome recovery, permanent deletion identity history, and structural collection movement. Migration 008's identity/generation history deliberately outlives the recoverable snapshots; do not purge it with 30-day Trash cleanup. Ship the new extension restore/move protocol only after these migrations are applied.
