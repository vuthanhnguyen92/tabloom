import { WorkspaceCommandError, type WorkspaceCommandErrorCode } from "../../../../shared/trash";
...
/** Only stable codes and service-owned messages cross the MCP boundary. */
export function mapWorkspaceCommandError(error: unknown): WorkspaceCommandError {
  ...
  return commandError("validation_failed");
}
